...
1. Add it to the `index.html` by creating a new line (copy pasting the one below).
...
1. Go back to your "post" and edit `line 36` adding the markdown file.
![image5](./images/image5.png)
1. Create the "post" in the markdown file and you're done. Don't forget to commit and push the changes.
